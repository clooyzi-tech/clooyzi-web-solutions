      ...
      <header className="fixed top-0 left-0 z-50 w-full bg-[#292929]/80 backdrop-blur-md border-b border-none">
        <div className="container flex h-16 items-center justify-between px-4">
          ...
          <nav className="hidden md:flex items-center justify-center">
              <div  className="flex items-center font-bold gap-6 bg-[#292929] rounded-full px-5 py-2 backdrop-blur-md transition-all duration-500" style={{fontFamily: "'Poppins', sans-serif",boxShadow: "0 0 5px #0066ffff",}}>
          ...
          <Button
            onClick={handleClick}
            className="hidden sm:inline-flex rounded-xl px-3 py-1 text-white shadow-neumorphism-photopage hover:shadow-neumorphism-hover-photopage focus:outline-none font-medium">
            Get Started
          </Button>
              ...
              className= {`fixed top-0 right-0 h-screen w-64 bg-[#292929]/95 backdrop-blur-md flex flex-col items-start py-6 px-6 gap-6 z-50 transform transition-transform duration-700 ease-out opacity-0 transition-opacity duration-700 ease-out ${mobileOpen ? 'translate-x-0 opacity-100' : 'translate-x-full opacity-0'}`}>
                ...
                {/* CTA Button */}
                  <Button
                    ...
                    className="mt-6 w-full rounded-xl px-3 py-2 text-white shadow-neumorphism-audiopage hover:shadow-neumorphism-hover-photopage focus:outline-none font-medium transition-all duration-300"
                  >
                    Get Started
                  </Button>
              </div>
