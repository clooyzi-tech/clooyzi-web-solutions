...
export default function Home() {
  ...
  return (
      ...
      <header className="fixed top-0 left-0 z-50 w-full bg-[#292929]/80 backdrop-blur-md border-b border-none">
        <div className="container flex h-16 items-center justify-between px-4">
          ...
          <nav className="hidden md:flex items-center justify-center">
              <div  className="flex items-center font-bold gap-6 bg-[#29292] rounded-full px-5 py-2 backdrop-blur-md transition-all duration-500" style={{fontFamily: "'Poppins', sans-serif",boxShadow: "0 0 5px #00ff91ff",}}>
          ...
          <Button
            onClick={handleClick}
            className="hidden sm:inline-flex rounded-xl px-3 py-1 text-white shadow-neumorphism-videopage hover:shadow-neumorphism-hover-videopage focus:outline-none font-medium">
            Get Started
          </Button>
              ...
              className= {`fixed top-0 right-0 h-screen w-64 bg-[#292929]/95 backdrop-blur-md flex flex-col items-start py-6 px-6 gap-6 z-50 transform transition-transform duration-700 ease-out opacity-0 transition-opacity duration-700 ease-out ${mobileOpen ? 'translate-x-0 opacity-100' : 'translate-x-full opacity-0'}`}>
                ...
                {/* CTA Button */}
                  <Button
                    ...
                    className="mt-6 w-full rounded-xl px-3 py-2 text-white shadow-neumorphism-videopage hover:shadow-neumorphism-hover-videopage focus:outline-none font-medium transition-all duration-300"
                  >
                    Get Started
                  </Button>
              </div>
      ...
      <div className="fixed inset-0 -z-20 animate-gradient bg-gradient-to-r from-violet-700 via-green-600 to-indigo-700"></div>

      {/* ✨ Floating Tech Icons */}
      <div className="fixed inset-0 -z-10 overflow-hidden">
        {/* Big primary icons */}
        <Code className="floating-icon text-white/20 h-12 w-12 top-10 left-10" />
        <Smartphone className="floating-icon text-white/20 h-14 w-14 top-1/3 left-1/4" />
        <Bot className="floating-icon text-white/20 h-16 w-16 top-1/2 right-10" />
        <Shield className="floating-icon text-white/20 h-12 w-12 bottom-20 left-1/3" />
        <Globe className="floating-icon text-white/20 h-14 w-14 bottom-10 right-1/4" />
        <Database className="floating-icon text-white/20 h-12 w-12 top-1/4 right-1/3" />

        {/* Smaller secondary icons strategically placed */}
        <Code className="floating-icon text-white/15 h-6 w-6 top-5 left-1/6 animate-float-fast" />
        <Smartphone className="floating-icon text-white/15 h-7 w-7 top-14 left-1/3 animate-float-slow" />
        <Bot className="floating-icon text-white/15 h-8 w-8 top-1/5 right-1/5 animate-float-fast" />
        <Shield className="floating-icon text-white/15 h-6 w-6 top-1/4 right-1/6 animate-float-slow" />
        <Globe className="floating-icon text-white/15 h-7 w-7 top-1/3 left-2/3 animate-float-fast" />
        <Database className="floating-icon text-white/15 h-6 w-6 top-1/2 left-1/6 animate-float-slow" />
        <Code className="floating-icon text-white/15 h-7 w-7 top-2/3 right-1/5 animate-float-fast" />
        <Smartphone className="floating-icon text-white/15 h-6 w-6 top-3/4 left-1/4 animate-float-slow" />
        <Bot className="floating-icon text-white/15 h-8 w-8 top-4/5 right-1/3 animate-float-fast" />
        <Shield className="floating-icon text-white/15 h-7 w-7 top-5/6 left-1/2 animate-float-slow" />
        <Globe className="floating-icon text-white/15 h-6 w-6 bottom-20 left-1/5 animate-float-fast" />
        <Database className="floating-icon text-white/15 h-7 w-7 bottom-16 right-1/6 animate-float-slow" />
        <Code className="floating-icon text-white/15 h-6 w-6 bottom-12 left-1/3 animate-float-fast" />
        <Smartphone className="floating-icon text-white/15 h-7 w-7 bottom-24 right-1/4 animate-float-slow" />
        <Bot className="floating-icon text-white/15 h-6 w-6 bottom-10 left-2/5 animate-float-fast" />
      </div>
        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 text-center px-4 md:px-6 text-white">
            <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl drop-shadow-lg">
              Innovative Tech Solutions for Your Business anna video
            </h1>
